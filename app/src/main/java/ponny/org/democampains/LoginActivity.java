...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        irInicio=new Intent(this, MainActivity.class);
        if(usuario.getSession()){
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            boolean creo=false;
            try {
              /*  AppDatabase mDb = Room.inMemoryDatabaseBuilder(LoginActivity.this, AppDatabase.class).build();
                PacienteRoom pacienteRoom=new PacienteRoom("1","1","2","3");
                mDb.pacienteDao().insertAll(pacienteRoom);
                Log.println(Log.ASSERT,"SQL",mDb.pacienteDao().getAll().size()+"");*/
                // Simulate network access.
                creo=usuario.getSession();
                Thread.sleep(1000);
